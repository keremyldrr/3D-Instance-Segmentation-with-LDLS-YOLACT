...
class LidarSegmentation(object):
    ...
    def __init__(self, projection, num_iters=10, num_neighbors=10,
                 distance_scale=1.0,
    ...
    def project_livox_points(self, lidar):
        return self.projection.project_livox(lidar)
    ...
    def point_nearest_neighbors(self, lidar):
        ...
        distances,neighbors = kdt.query(lidar,self.num_neighbors)
    ...
    def run(self, lidar, detections, max_iters=200, device=0, save_all=True):
        with cp.cuda.Device(device):
            ...
            projected = self.project_livox_points(lidar)
            ...
            #print("remaining points ",n_points) 
            ...
            pixel_labels = np.concatenate([detections.get_background().reshape((n_pixels, 1)),pixel_labels], axis=1)
            ...
            if self.outlier_removal:
                ...
                #print(initial_lidar_labels.shape)
